...
from lab_02.distribution import PoissonDistribution
from lab_02.generator import Generator
from lab_02.processor import Processor
from lab_02.request import REQUEST_TYPE_ONE, REQUEST_TYPE_TWO
from lab_02.simulator import Simulator
...
class Pfe:
    ...
    def create_dfe2_plan_matrix(self):
        """Создать матрицу для полуреплики"""
        column_names = [
