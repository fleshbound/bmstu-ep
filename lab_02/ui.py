...
class UI:
    ...
    def create_pfe_widgets(self):
        ...
        self.lambda1_min_pfe_val = tk.DoubleVar(value=1.0)
        ...
        self.lambda1_max_pfe_val = tk.DoubleVar(value=5.0)
        ...
        self.lambda1_norm_pfe_val = tk.DoubleVar(value=5.0)
        ...
        self.lambda2_min_pfe_val = tk.DoubleVar(value=1.0)
        ...
        self.lambda2_max_pfe_val = tk.DoubleVar(value=5.0)
        ...
        self.lambda2_norm_pfe_val = tk.DoubleVar(value=5.0)
        ...
        self.mu1_min_pfe_val = tk.DoubleVar(value=1.0)
        ...
        self.mu1_max_pfe_val = tk.DoubleVar(value=5.0)
        ...
        self.mu1_norm_pfe_val = tk.DoubleVar(value=5.0)
        ...
        self.mu2_min_pfe_val = tk.DoubleVar(value=1.0)
        ...
        self.mu2_max_pfe_val = tk.DoubleVar(value=5.0)
        ...
        self.mu2_norm_pfe_val = tk.DoubleVar(value=5.0)
        ...
        self.pfe_widgets = [
            ...
            self.requests_pfe_label, self.requests_pfe, self.pfe_run_button
        ]
